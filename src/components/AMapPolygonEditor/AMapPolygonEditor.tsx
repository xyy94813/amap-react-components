...
const AMapPolygonEditor: FC<AMapPolygonEditorProps> = ({
  ...
  useEffect(() => {
    ...
    clearEffect = () => {
      map.off('removedOverlays' as AMap.EventType, handleOverlayChanged);
      map.off('addedOverlays' as AMap.EventType, handleOverlayChanged);
    };
    map.on('removedOverlays' as AMap.EventType, handleOverlayChanged);
    map.on('addedOverlays' as AMap.EventType, handleOverlayChanged);
