import{R as t,r as o}from"./index-RYns6xqu.js";import{c as y,u as d}from"./AMapRangingTool-CmppYZ_3.js";const S="38755ba5e44be7ed58efbbc70101fbbf",v={title:"组件(Components)/基础组件(Basic)/AMapAPIContainer"},u=(e,n)=>{new e.ControlBar().addTo(n),new e.ToolBar({position:"LT",offset:[50,120]}).addTo(n),new e.Scale().addTo(n),new e.HawkEye().addTo(n)},p=(e,n)=>{new e({iconTheme:"numv1",iconStyle:"start",position:[116.405285,39.904989]}).addTo(n)},I=y({key:S,version:"2.0",AMapUI:{version:"1.1"}}),_=()=>{const{__AMAP__:e}=d(),n=o.useRef(null),c=o.useRef(null);return o.useEffect(()=>{let l;if(!e||!n.current)return l;const r=new e.Map(n.current);return c.current=r,e.plugin(["ControlBar","ToolBar","Scale","MapType","HawkEye"].map(a=>`AMap.${a}`),()=>u(e,r)),AMapUI.loadUI("overlay/SimpleMarker",a=>{p(a,r)}),l=()=>{r.destroy()},l},[e]),t.createElement("div",{ref:n,style:{height:400}})},E=`
